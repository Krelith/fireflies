class Firefly {
  ...
  */
  ...
  void show() {
    ...
    if (frameCount % 5 == 0){
      stroke(255);
      line(location.x - 1, location.y - 3, location.x, location.y);
      line(location.x + 35, location.y - 3, location.x, location.y);
      line(location.x - 1, location.y, location.x, location.y);
      line(location.x + 35, location.y, location.x, location.y);
    }
    noStroke();
